            ...
            <section className='w-full h-screen flex flex-col justify-between items-center presentation m-auto'>
                <div className='container flex flex-col gap-16 mx-auto justify-between items-center mt-32 md:mt-36 lg:mt-0 lg:flex-row lg:gap-0 w-10/12 h-screen'>
                    <div className='flex flex-col mx-auto items-start gap-10 lg:w-7/12'>
                        <h1 className='font-extrabold text-start leading-14 text-5xl text-white font-archivo md:text-8xl md:leading-24 lg:text-center'>Web Developer & UX/UI Designer</h1>
                        <p className='text-2xl text-start text-gray1 text-neutral100 lg:text-center lg:mx-auto'>Unleash the Power of Technology & Elevate Your Digital Presence</p>

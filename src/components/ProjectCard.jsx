function ProjectCard({ title, poster, logo, description, url }) {
    return (
        <div className='flex flex-col justify-center items-center bg-white shadow-lg w-12/12 gap-2 md:w-5/12 lg:w-3/12 rounded-xl'>
            <div>
            ...
            <div className='px-4 py-5 flex flex-col gap-4'>
                <div className='flex gap-5'>
                    ...
                    <span className="text-xl font-medium text-backgroundBlack">{title}</span>
                </div>
